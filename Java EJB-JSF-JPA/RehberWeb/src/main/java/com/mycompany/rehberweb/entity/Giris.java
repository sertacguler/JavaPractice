...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Giris.girisKontrol", query = "SELECT g FROM Giris g where g.kullanici = :kullanici and g.sifer = :sifre")
    ...
    , @NamedQuery(name = "Giris.findBySifer", query = "SELECT g FROM Giris g WHERE g.sifer = :sifer")})
public class Giris implements Serializable {
    ...
    public String getSifer() {
        return sifer;
    }

    public void setSifer(String sifer) {
        this.sifer = sifer;
    }
    ...
    public String toString() {
        return "com.mycompany.rehberweb.entity.Giris[ no=" + no + " ]";
    }
